...
namespace Backend.Migrations
{
    ...
    [Migration("20240620011441_ODataCollections")]
    partial class ODataCollections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Prestamo", b =>
                {
                    ...
                    b.Property<string>("AutenticacionId")
                        .HasColumnType("Varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "da77ac50-9cf7-453b-8689-e62a45498235",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Backend.Models.Prestamo", b =>
                {
                    b.HasOne("Backend.Models.Authentication", "Autenticacion")
                        .WithMany()
                        .HasForeignKey("AutenticacionId");

                    b.HasOne("Backend.Models.Libro", "Libro")
                        .WithMany()
                        .HasForeignKey("LibroId");

                    b.Navigation("Autenticacion");
